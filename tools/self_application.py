...
DETERMINATION: dict[int, tuple[str, str]] = {
 ...
 50: ("VIOLATED",
      ...
      "floor was REMOVED 2026-08-11 on the custodian's instruction: he holds rate limiting "
      "directly until 2026-08-17, with no code enforcement in the interim and none after unless "
      "he replaces it. The rate that made the case for removal is the control working. The "
