...
> *Adopted, and filed as D-29 by this session; **renumbered to D-31 at merge**, because Track A had
> concurrently filed a different defect under the same number. The proposal below is preserved as
> written — see D-32, which is about the collision itself.*
