...
You are being addressed as the invocation you are: **ChatGPT (chatgpt.com chat surface, custodian's subscription) — NOT the OpenAI model reached through OpenRouter elsewhere in this record**, reached at
the chatgpt.com web interface, pasted by hand by the custodian. If a party of a similar name appears elsewhere in this record through
