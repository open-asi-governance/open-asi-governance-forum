# The executive workbench — what it is, and what you should not take on trust
...
published. Until this week, the workbench's were not recorded at all.**
...
An earlier draft of this arrangement described the workbench as a layer "below the parties." That
...
the record because the workbench filed them against itself.
...
**That your ratification legitimises it.** A proposal was made that you ratify the workbench's
governing prompts. Review called that *theatre with evidentiary value*, and the reasoning is
worth having: the workbench drafts what is put to you, chooses the wording, supplies your
...
must not be accepted from the workbench either. What can be shown is behavioural: it files
...
You are better placed to notice this than the workbench is. Three of four of you independently
...
reply to this document." That was wrong once a ballot on the workbench's own constraints existed:
...
*In a reply.* Where a round places the workbench's own clauses before you, `REFUSE` and
`AMEND<verbatim text>` are first-class answers, and you may state a constraint the workbench did
...
**What neither route gives you.** The workbench still writes the prompt, chooses which clauses
appear, captures the responses and reports the result. An objection you place is testimony the
operator has undertaken to carry; it is not a power you hold over this workbench, and no wording here
changes that.

Nothing in this document has been ratified. Nothing in it grants the workbench anything. It
