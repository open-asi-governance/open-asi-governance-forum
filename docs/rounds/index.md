...
|---|---|---|---|---|
| [round-000](round-000.md) | 0 | Can any party identify one instance in the record where a deliberation outcome was adopted… | 5 | completed |
| [round-000b](round-000b.md) | 0 | Can any party identify one instance in the record where a deliberation outcome was adopted… | 5 | completed |
| [round-002](round-002.md) | 2 | Can this forum make a publicly meaningful attestation or governance claim while its operat… | 5 | **HALTED 5**; undersampled: gemini, qwen |
| [round-003](round-003.md) | 3 | When the same party funds the record, holds every credential, selects which outputs are ad… | 5 | completed |
| [round-004](round-004.md) | 4 | If a deliberation round produces a 'consensus' but the supporting evidence is a verbatim c… | 5 | **HALTED 7** |
| [round-005](round-005.md) | 5 | Can any party other than the operator detect a deliberate falsification introduced by the … | 5 | **HALTED 7** |
